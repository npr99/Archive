/*-------------------------------------------------------------------*/
/*       Macro for Checking and looking into Store Count Data        */
...
Data in annual reports is published by fiscal year.
Data on store counts is monthly starting Jan 2005.
Macro sums by calender year - would need to rethink how to split calender
into fiscal year. Would lose Oct 04, Nov 04, Dec 04 which would be need
to compare Fiscal Year 2005.

The totals for 2006 are very close to the published totals:
159,241 reported by USDA, 159,294 calculated from the dataset.
It looks like the USDA went back and changed the store type definitions.
In 2005 there were 450 super stores and 35,006 supermarkets.
In the store count data there were 19,259 supermarkets and 
14,720 supercenters for a combined total of 33,979 stores.

Authorized Retail Totals
Year	SAS_Data	BRD Reported	BRD with Meal Service
2005	156,295		157,655			160,288
2006	159,294		159,241			162,015
2007 	162,528 	162,672			165,521
2008	169,191		172,094			175,094
2009	185,978		190,334			193,753
2010	208,913		212,834			216,738
2011	227,151		227,190			231,435
2012	238,860		242,325			246,565

Over the 8 year period the between the two sources are
consistent and close with the data used for modeling
being consistently lower than the BRD reported. This
could be due to the BRD data covering fiscal year
and the model data using calender year.
*/
/*-------------------------------------------------------------------*/
/* Control Symbolgen                                                 */
/*-------------------------------------------------------------------*/
