...
CY 2005 - CY 2012 Redemptions by ST-County - Redacted.xlsx" DBMS = XLSX 
OUT = USDA.CountyRedemptions REPLACE;
	RANGE = "Sheet$A2:E24981";
	MIXED = YES;
RUN;
...
PROC SGPLOT DATA = CountyWCR_HistState;
	...
	TITLE '&StateTitle Within County Redemptions 2006-2010';
Run;
PROC SGPLOT DATA = CountyWCR_HistState;
...
/*-------------------------------------------------------------------*/
/*  Creating TXHHS Data for 2006-2012                               */
/*-------------------------------------------------------------------*/
...
/*-------------------------------------------------------------------*/
/*  Generate Summary Statistics for WCR                              */
/*-------------------------------------------------------------------*/
...
proc MEANS data=USDA.TXCountyWCR_Long MEDIAN;
	Title 'Summary of Texas Within County Redemptions By Year';
	By Year;
	VAR WCR;
run;
