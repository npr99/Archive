...
proc export data= &library..DropData&library._&state.&FYear._&LYear 
    outfile= "&dd_data.Dissertation\Oct18&main_library.&state._&Fyear._&Lyear..dta"
	Replace;
run;
