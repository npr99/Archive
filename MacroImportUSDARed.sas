...
Data model1.&state.&geolevel.&Fyear._&Lyear.USDARed;
	set CountyRedemptions;
	if year ge &fyear AND year le &lyear;
	mergeyear = put(year,4.); * Year needs to be a string;
	drop year;
...
Data model1.&state.&geolevel.&Fyear._&Lyear.USDARed;
	...
	Set model1.&state.&geolevel.&Fyear._&Lyear.USDARed;
	If StateFP = &Statefp;
run;

Proc Sort data = model1.&state.&geolevel.&Fyear._&Lyear.USDARed
	out = model1.&state.&geolevel.&Fyear._&Lyear.USDARed;
	by FIPS_county year;
Run;
