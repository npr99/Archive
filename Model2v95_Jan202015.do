...
local prjctdir1 = "`rootdir'\MyProjects\\`prjct'"
local outputdir2 = "`prjctdir1'\Hold then delete\"
local datadir = "`rootdir'\MyData\Dissertation\"

/*-------------------------------------------------------------------*/
/* Set Linse Size - 80 Characters for Readabilty                     */
/*-------------------------------------------------------------------*/
...
log using `"`outputdir2'StataLogs\model_`model'_`time_string'.log"', text

/*-------------------------------------------------------------------*/
/* Set scheme - SSCCL from Sheather 2009                             */
/*-------------------------------------------------------------------*/
// Change directory that contains schemes
cd "`outputtex_fig'\"
set scheme ssccl
...
/*-------------------------------------------------------------------*/
/* Controlling STATA - Set Stata Version and Clear Memory            */
/*-------------------------------------------------------------------*/
...
/*-------------------------------------------------------------------*/
// Run saved do file that creates dependent variable options
do Posted\DataClean\CreateDependentVariables.do
...
histogram `dep_var' if year == 2008, freq normal ///
...
/*-------------------------------------------------------------------*/
/* Discussion With Walt Peacock                                      */
/*-------------------------------------------------------------------*/

xtreg `dep_var' `model_expvars', fe
...
local model_expvars `model1_redvar2' `model1_basevars' `model2_vars'
